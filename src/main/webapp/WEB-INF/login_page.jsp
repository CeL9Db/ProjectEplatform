                ...
                <div class="container_login">
                    <form method="post" action=/login>
                        ...
                        <span class="block_login">
                            <input type="email" placeholder="email" name="email" autocomplete="off" required class="input_login"/>
                            <i class='bx bxl-gmail'></i>
                        </span>
                        <label for="password">Password:</label>
                        <span class="block_login">
                            <input type="password" placeholder="password" name="password" autocomplete="off" required class="input_login"/>
